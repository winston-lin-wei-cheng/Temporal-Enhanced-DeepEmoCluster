...
if __name__=='__main__': 
    ...
    # Setting I/O Paths    
    input_path = '/media/winston/UTD-MSP/Speech_Datasets/MSP-PODCAST-Publish-1.8/Audio/'
    output_path = '/media/winston/UTD-MSP/Speech_Datasets/MSP-PODCAST-Publish-1.8/Features/Mel_Spec128/feat_mat/'
